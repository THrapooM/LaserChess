...
public class StartingBoard {
	...
	public static final ChessPiece[][][] startingBoard = 
		{ 
				{{new LaserTower(2,0,0,1), null, null, null, new Defender(2,0,4,1),new King(2,0,5,1),new Defender(2, 0, 6, 1),new Deflector(1, 0, 7, 1),null,null},
				...
				{new Deflector(1,3,0,1),null,new Deflector(2,3,2,2),null,new Switch(0, 3, 4, 1),new Switch(1,3,5,1),null,new Deflector(1,3,7,1),null,new Deflector(3,3,9,2)},
				{new Deflector(2,4,0,1),null,new Deflector(3,4,2,2),null,new Switch(1,4,4,2),new Switch(0,4,5,2),null,new Deflector(1,4,7,1),null,new Deflector(3,4,9,2)},
				{null,null,null,null,null,null,new Deflector(1,5,6,1),null,null,null},
				{null,null,null,null,null,null,null,new Deflector(1,6,6,2),null,null},
